  ...
  <div id="box">
        ...
        <div class="panel-body">
            <table class="table table-bordered">
                ...
                ?>
                <tr>
                    <td><img style="width:100px; height: 70px;" src="../public/images/<?php echo $user['image'];?>" /></td>
                    <td style="width: 100px;"><?php echo $user['name'] ?></td>
                    <td style="width: 100px"><?php echo $user['gender'] ?></td>
