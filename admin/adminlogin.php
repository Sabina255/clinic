...
//admin login
$admin_query = "SELECT * FROM users WHERE email='$email' and password='$password' and role_id=1";
...
<head>
    ...
    <title>Elina Clinic</title>
    <!-- Bootstrap Core CSS -->
    <link href="bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
   <!--  <link href="../public/plugins/bower_components/bootstrap-extension/css/bootstrap-extension.css" rel="stylesheet"> -->
    <!-- animation CSS -->
...
<body >
        ...
        <div class="login-box login-sidebar" style="background-color: #222;margin: 100px auto;position:relative;border:1px solid rgb(3, 169, 243);height:390px;border-radius:3px;">
            <div class="white-box" style="padding-top:50px;">
                <form class="form-horizontal form-material" method="POST" id="loginform" action="">
                    <!-- <a href="javascript:void(0)"><img  style="width:30px; height: 30px;" src="../public/plugins/images/log.jpg" alt="Home" /> -->
    ...
    <script src="../public/plugins/bower_components/bootstrap-extension/js/bootstrap-extension.min.js"></script>
